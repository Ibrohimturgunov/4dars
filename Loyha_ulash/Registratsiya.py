...
class RegistrationWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.save_button.setStyleSheet("background-color: red; color: blue")
        self.save_button.clicked.connect(self.on_register)
        self.back_btn = QPushButton("Back")
        self.back_btn.setStyleSheet("background-color: red; color: blue")
        self.Qbox.addWidget(self.back_btn)
        self.Qbox.addWidget(self.save_button)
        self.vbox.addLayout(self.Qbox)
        self.back_btn.clicked.connect(self.ortga)
